...
static const char *const yytname[] =
{
  ...
  "MAIN", "INT", "'('", "')'", "'{'", "'}'", "';'", "','", "'='", "'+'",
  "'*'", "'/'", "$accept", "program", "declarations", "id_list",
...
{
      12,    15,    23,    16,   -17,    17,    19,    24,    25,   -17,
      -9,    14,     8,   -17,   -17,    26,    -3,   -17,   -17,   -17,
     -17,    -3,     5,    -8,   -17,    -3,    -3,    -3,   -17,    -1,
      -1,    -1
};
...
{
      28,    20,    14,    15,    21,    23,    25,    26,    27,    29,
      30,    31,    11,    25,    26,    27,    24,     1,    17,    25,
      26,    27,     3,     4,     5,     7,     6,    16,     9,    11,
      19,     0,    18
};

static const yytype_int8 yycheck[] =
{
       8,     4,    11,    12,     7,    21,    14,    15,    16,    25,
      26,    27,     4,    14,    15,    16,    11,     5,    10,    14,
      15,    16,     7,     0,     8,     6,     9,    13,     4,     4,
       4,    -1,    12
};
...
{
       0,     5,    18,     7,     0,     8,     9,     6,    19,     4,
      20,     4,    21,    22,    11,    12,    13,    10,    22,     4,
       4,     7,    23,    23,    11,    14,    15,    16,     8,    23,
      23,    23
};
...
#line 72 "parser.y"
                             { emit('=', (yyvsp[-1].expr).addr, "", (yyvsp[-3].id)); }
#line 1190 "y.tab.c"
    break;

  case 9: /* expr: IDENTIFIER  */
#line 76 "parser.y"
                { (yyval.expr).addr = (yyvsp[0].id); }
#line 1196 "y.tab.c"
    break;
...
#line 77 "parser.y"
        ...
        emit('+', (yyvsp[-2].expr).addr, (yyvsp[0].expr).addr, (yyval.expr).addr);
    }
#line 1205 "y.tab.c"
    break;
